  ...
  <div class="seccion-perfil">
    <div class="contenedor contenedor-perfil">
      ...
      <form method="POST" class="form-perfil">
        ...
        <div class="nacimiento-alumno flex flex-3">
          <div class="campo mes">
            <div class="label-container">
          ...
          <div class="campo año">
            ...
            <div class="input-container">
              <select name="año" id="año" class="input_perfil" required disabled>
                <option selected disabled value="<?= $usuario['añoNac'] ?>">
                  <?= $usuario['añoNac'] ?></option>
              </select>
              <i class="far fa-times-circle"></i>
              <i class="far fa-check-circle icon-correcto"></i>
            </div>
          ...
          <div class="campo dia">
            ...
            <div class="input-container">
              <select name="dia" id="dia" required class="input_perfil" disabled>
                <option selected disabled value="<?= $usuario['diaNac'] ?>">
                  <?= $usuario['diaNac'] ?></option>
              </select>
              <i class="far fa-times-circle"></i>
              <i class="far fa-check-circle icon-correcto"></i>
            </div>
          ...
          <div class="campo">
            ...
            <div class="input-container">
              <select name="cinta" id="cinta" required class="input_perfil" disabled>
                <option value="<?= strtolower($usuario['cinta']) ?>" disabled selected>
                  <?= ucwords($usuario['cinta']) ?>
                </option>
